describe('Update review', () => {
  ...
  it('accessing a non-existent review redirects to the main page', () => {
    cy.intercept('GET', 'http://localhost:3000/api/v1/reviews/1', 'undefined')
    cy.intercept(
      'GET',
      'http://localhost:3000/api/v1/current_user/id',
      'undefined',
    )
  ...
  it('If reviewee accesses', () => {
    ...
    cy.intercept('PATCH', 'http://localhost:3000/api/v1/reviews/1', {
      statusCode: 200,
    })
