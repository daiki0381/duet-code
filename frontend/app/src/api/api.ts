...
export type RepositoryTemplateRepositorySquashMergeCommitTitleEnum = typeof RepositoryTemplateRepositorySquashMergeCommitTitleEnum[keyof typeof RepositoryTemplateRepositorySquashMergeCommitTitleEnum];
...
export type RepositoryTemplateRepositorySquashMergeCommitMessageEnum = typeof RepositoryTemplateRepositorySquashMergeCommitMessageEnum[keyof typeof RepositoryTemplateRepositorySquashMergeCommitMessageEnum];
export const RepositoryTemplateRepositoryMergeCommitTitleEnum = {
    PrTitle: 'PR_TITLE',
    MergeMessage: 'MERGE_MESSAGE'
} as const;

export type RepositoryTemplateRepositoryMergeCommitTitleEnum = typeof RepositoryTemplateRepositoryMergeCommitTitleEnum[keyof typeof RepositoryTemplateRepositoryMergeCommitTitleEnum];
...
export type RepositoryTemplateRepositoryMergeCommitMessageEnum = typeof RepositoryTemplateRepositoryMergeCommitMessageEnum[keyof typeof RepositoryTemplateRepositoryMergeCommitMessageEnum];
...
export const GitHubApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        acceptInvitation: async (invitationId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'invitationId' is not null or undefined
            assertParamExists('acceptInvitation', 'invitationId', invitationId)
            const localVarPath = `/user/repository_invitations/{invitation_id}`
         ...
         * @throws {RequiredError}
         */
        addCollaborator: async (owner: string, repo: string, username: string, addCollaboratorRequest?: AddCollaboratorRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(addCollaboratorRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getInvitations: async (owner: string, repo: string, perPage?: number, page?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getPublicRepos: async (since?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getPulls: async (owner: string, repo: string, state?: 'open' | 'closed' | 'all', head?: string, base?: string, sort?: 'created' | 'updated' | 'popularity' | 'long-running', direction?: 'asc' | 'desc', perPage?: number, page?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        reviewRequest: async (owner: string, repo: string, pullNumber: number, reviewRequestRequest?: ReviewRequestRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            ...
            const localVarPath = `/repos/{owner}/{repo}/pulls/{pull_number}/requested_reviewers`
                .replace(`{${"owner"}}`, encodeURIComponent(String(owner)))
                .replace(`{${"repo"}}`, encodeURIComponent(String(repo)))
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(reviewRequestRequest, localVarRequestOptions, configuration)
...
export const GitHubApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async acceptInvitation(invitationId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async addCollaborator(owner: string, repo: string, username: string, addCollaboratorRequest?: AddCollaboratorRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryInvitation>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addCollaborator(owner, repo, username, addCollaboratorRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * When authenticating as a user with admin rights to a repository, this endpoint will list all currently open repository invitations.
         ...
         * @throws {RequiredError}
         */
        async getInvitations(owner: string, repo: string, perPage?: number, page?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RepositoryInvitation>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getInvitations(owner, repo, perPage, page, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Lists all public repositories in the order that they were created.  Note: - For GitHub Enterprise Server, this endpoint will only list repositories available to all users on the enterprise. - Pagination is powered exclusively by the `since` parameter. Use the [Link header](https://docs.github.com/rest/overview/resources-in-the-rest-api#link-header) to get the URL for the next page of repositories.
         ...
         * @throws {RequiredError}
         */
        async getPublicRepos(since?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MinimalRepository>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPublicRepos(since, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Draft pull requests are available in public repositories with GitHub Free and GitHub Free for organizations, GitHub Pro, and legacy per-repository billing plans, and in public and private repositories with GitHub Team and GitHub Enterprise Cloud. For more information, see [GitHub\'s products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
         ...
         * @throws {RequiredError}
         */
        async getPulls(owner: string, repo: string, state?: 'open' | 'closed' | 'all', head?: string, base?: string, sort?: 'created' | 'updated' | 'popularity' | 'long-running', direction?: 'asc' | 'desc', perPage?: number, page?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PullRequestSimple>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPulls(owner, repo, state, head, base, sort, direction, perPage, page, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoint triggers [notifications](https://docs.github.com/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See \"[Secondary rate limits](https://docs.github.com/rest/overview/resources-in-the-rest-api#secondary-rate-limits)\" and \"[Dealing with secondary rate limits](https://docs.github.com/rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)\" for details.
         ...
         * @throws {RequiredError}
         */
        async reviewRequest(owner: string, repo: string, pullNumber: number, reviewRequestRequest?: ReviewRequestRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PullRequestSimple>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.reviewRequest(owner, repo, pullNumber, reviewRequestRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const GitHubApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addCollaborator(owner: string, repo: string, username: string, addCollaboratorRequest?: AddCollaboratorRequest, options?: any): AxiosPromise<RepositoryInvitation> {
            return localVarFp.addCollaborator(owner, repo, username, addCollaboratorRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * When authenticating as a user with admin rights to a repository, this endpoint will list all currently open repository invitations.
         * @summary List repository invitations
         ...
         * @throws {RequiredError}
         */
        getInvitations(owner: string, repo: string, perPage?: number, page?: number, options?: any): AxiosPromise<Array<RepositoryInvitation>> {
            return localVarFp.getInvitations(owner, repo, perPage, page, options).then((request) => request(axios, basePath));
        },
        /**
         * Lists all public repositories in the order that they were created.  Note: - For GitHub Enterprise Server, this endpoint will only list repositories available to all users on the enterprise. - Pagination is powered exclusively by the `since` parameter. Use the [Link header](https://docs.github.com/rest/overview/resources-in-the-rest-api#link-header) to get the URL for the next page of repositories.
         * @summary List public repositories
         ...
         * @throws {RequiredError}
         */
        getPublicRepos(since?: number, options?: any): AxiosPromise<Array<MinimalRepository>> {
            return localVarFp.getPublicRepos(since, options).then((request) => request(axios, basePath));
        },
        /**
         * Draft pull requests are available in public repositories with GitHub Free and GitHub Free for organizations, GitHub Pro, and legacy per-repository billing plans, and in public and private repositories with GitHub Team and GitHub Enterprise Cloud. For more information, see [GitHub\'s products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
         * @summary List pull requests
         ...
         * @throws {RequiredError}
         */
        getPulls(owner: string, repo: string, state?: 'open' | 'closed' | 'all', head?: string, base?: string, sort?: 'created' | 'updated' | 'popularity' | 'long-running', direction?: 'asc' | 'desc', perPage?: number, page?: number, options?: any): AxiosPromise<Array<PullRequestSimple>> {
            return localVarFp.getPulls(owner, repo, state, head, base, sort, direction, perPage, page, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint triggers [notifications](https://docs.github.com/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See \"[Secondary rate limits](https://docs.github.com/rest/overview/resources-in-the-rest-api#secondary-rate-limits)\" and \"[Dealing with secondary rate limits](https://docs.github.com/rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)\" for details.
         * @summary Request reviewers for a pull request
         ...
         * @throws {RequiredError}
         */
        reviewRequest(owner: string, repo: string, pullNumber: number, reviewRequestRequest?: ReviewRequestRequest, options?: any): AxiosPromise<PullRequestSimple> {
            return localVarFp.reviewRequest(owner, repo, pullNumber, reviewRequestRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GitHubApi extends BaseAPI {
    ...
    public acceptInvitation(invitationId: number, options?: AxiosRequestConfig) {
        return GitHubApiFp(this.configuration).acceptInvitation(invitationId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GitHubApi
     */
    public addCollaborator(owner: string, repo: string, username: string, addCollaboratorRequest?: AddCollaboratorRequest, options?: AxiosRequestConfig) {
        return GitHubApiFp(this.configuration).addCollaborator(owner, repo, username, addCollaboratorRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GitHubApi
     */
    public getInvitations(owner: string, repo: string, perPage?: number, page?: number, options?: AxiosRequestConfig) {
        return GitHubApiFp(this.configuration).getInvitations(owner, repo, perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getPublicRepos(since?: number, options?: AxiosRequestConfig) {
        return GitHubApiFp(this.configuration).getPublicRepos(since, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GitHubApi
     */
    public getPulls(owner: string, repo: string, state?: 'open' | 'closed' | 'all', head?: string, base?: string, sort?: 'created' | 'updated' | 'popularity' | 'long-running', direction?: 'asc' | 'desc', perPage?: number, page?: number, options?: AxiosRequestConfig) {
        return GitHubApiFp(this.configuration).getPulls(owner, repo, state, head, base, sort, direction, perPage, page, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GitHubApi
     */
    public reviewRequest(owner: string, repo: string, pullNumber: number, reviewRequestRequest?: ReviewRequestRequest, options?: AxiosRequestConfig) {
        return GitHubApiFp(this.configuration).reviewRequest(owner, repo, pullNumber, reviewRequestRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const NotificationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createNotification: async (createNotification?: CreateNotification, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        updateNotification: async (notificationId: string, updateNotification?: UpdateNotification, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(updateNotification, localVarRequestOptions, configuration)
...
export const NotificationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createNotification(createNotification?: CreateNotification, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNotification(createNotification, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async updateNotification(notificationId: string, updateNotification?: UpdateNotification, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateNotification(notificationId, updateNotification, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const NotificationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createNotification(createNotification?: CreateNotification, options?: any): AxiosPromise<void> {
            return localVarFp.createNotification(createNotification, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get notifications
         ...
         * @throws {RequiredError}
         */
        updateNotification(notificationId: string, updateNotification?: UpdateNotification, options?: any): AxiosPromise<void> {
            return localVarFp.updateNotification(notificationId, updateNotification, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class NotificationApi extends BaseAPI {
     ...
     */
    public createNotification(createNotification?: CreateNotification, options?: AxiosRequestConfig) {
        return NotificationApiFp(this.configuration).createNotification(createNotification, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof NotificationApi
     */
    public updateNotification(notificationId: string, updateNotification?: UpdateNotification, options?: AxiosRequestConfig) {
        return NotificationApiFp(this.configuration).updateNotification(notificationId, updateNotification, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PostApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updatePost: async (postId: string, updatePost?: UpdatePost, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'postId' is not null or undefined
...
export const PostApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updatePost(postId: string, updatePost?: UpdatePost, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const PostApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updatePost(postId: string, updatePost?: UpdatePost, options?: any): AxiosPromise<void> {
...
export class PostApi extends BaseAPI {
    ...
    public createPost(createPost?: CreatePost, options?: AxiosRequestConfig) {
        return PostApiFp(this.configuration).createPost(createPost, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PostApi
     */
    public updatePost(postId: string, updatePost?: UpdatePost, options?: AxiosRequestConfig) {
        return PostApiFp(this.configuration).updatePost(postId, updatePost, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async loginUser(loginUser?: LoginUser, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export class UserApi extends BaseAPI {
    ...
    public loginUser(loginUser?: LoginUser, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).loginUser(loginUser, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public logoutUser(userId: string, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).logoutUser(userId, options).then((request) => request(this.axios, this.basePath));
    }
}
